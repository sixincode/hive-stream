<div>
  <x-hive-display-section component='boxedSection' class="py-8">
              ...
              <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                  <li class="mr-0.5 md:mr-0 md:mb-0.5">
                      <a
                        ...
                        class="flex items-center px-2.5 py-2 rounded whitespace-nowrap bg-indigo-50"
                        href="#profile">
                          ...
                          <span class="text-sm font-medium text-indigo-500">Profile</span>
                      </a>
                  </li>
                  <li class="mr-0.5 md:mr-0 md:mb-0.5">
                      <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" h
                      ...
                      ref="#security">
                          ...
                          <span class="text-sm font-medium text-slate-600 hover:text-slate-700">Security</span>
                      </a>
                  </li>
                  <li class="mr-0.5 md:mr-0 md:mb-0.5">
                      <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" h
                      x-on:click.prevent="activeTab = 'notifications'"
                      ref="#notifications">
                          <svg class="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2" viewBox="0 0 16 16">
                              <path d="M14.3.3c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-8 8c-.2.2-.4.3-.7.3-.3 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l8-8zM15 7c.6 0 1 .4 1 1 0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8c.6 0 1 .4 1 1s-.4 1-1 1C4.7 2 2 4.7 2 8s2.7 6 6 6 6-2.7 6-6c0-.6.4-1 1-1z"></path>
                          </svg>
                  ...
                  <li class="mr-0.5 md:mr-0 md:mb-0.5">
                      ...
                      x-on:click.prevent="activeTab = 'plans'"
                      href="#plans"
                      >
                          <svg class="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2" viewBox="0 0 16 16">
                  ...
                  <li class="mr-0.5 md:mr-0 md:mb-0.5">
                      <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap"
                      x-on:click.prevent="activeTab = 'billing'"
                      href="#billing">
                          <svg class="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2" viewBox="0 0 16 16">
   ...
   <!-- Panel body -->
     <div x-cloak
           x-show="activeTab === 'profile' ">
             <x-hive-display-card source='user.profile' component='userProfile' />
      </div>

      <div x-cloak
           x-show="activeTab === 'security' ">
           <x-hive-display-card source='user.profile' component='userSecurity' />
      </div>

      <div x-cloak
           x-show="activeTab === 'notifications' ">
           <x-hive-display-card source='user.profile' component='userNotifications' />
      </div>

      <div x-cloak
           x-show="activeTab === 'plans' ">
           <x-hive-display-card source='user.profile' component='userPlans' />
      </div>

      <div x-cloak
           x-show="activeTab === 'billing' ">
           <x-hive-display-card source='user.profile' component='userBilling' />
      </div>
